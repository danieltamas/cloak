...
> **Early Software Notice:** Cloak is in active development (v0.4.4). Start with a non-critical project to verify it works for your setup. Please [report bugs](https://github.com/danieltamas/cloak/issues) — your feedback helps make Cloak rock-solid.
