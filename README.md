...
```
v0.1.0 — Core: CLI + extension, .env protection, auth gate (Touch ID + password)
v0.2.0 — Audit logging, git pre-commit hook, Linux file-based keychain fallback
